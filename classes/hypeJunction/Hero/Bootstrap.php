...
class Bootstrap extends PluginBootstrap {
	...
	public function init() {
		...
		\elgg_register_plugin_hook_handler('register', 'menu:hero', HeroMenu::class, 900);
		\elgg_register_plugin_hook_handler('register', 'menu:cover', CoverMenu::class, 900);
		\elgg_register_plugin_hook_handler('register', 'menu:actions', ActionsMenu::class, 900);
